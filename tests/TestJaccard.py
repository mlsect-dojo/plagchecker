...
class TestJaccardIndex(unittest.TestCase):
    def test_index_positive(self):
        ...
        self.assertEqual(JaccardIndex('his thought process was on so many levels that he gave himself a phobia of heights',
                                      'there is an art to getting your way and throwing bananas on to the street is not it'
                                      ), 0.6818181818181818)
        self.assertEqual(JaccardIndex('there is an art to getting your way and throwing bananas on to the street is not it',
